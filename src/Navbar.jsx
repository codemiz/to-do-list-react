  ...
  return (
    <div className='bg-slate-200 w-full h-14 flex justify-center items-center font-sans text-lg text-black drop-shadow-lg'>
      ...
      <ul className='flex gap-12 font-semibold'>
        ...
        <NavLink  className={(e)=>{return e.isActive? "bg-black text-amber-400": ""}} to={user?"/login":"/signup"}><li className='cursor-pointer hover:text-amber-400 hover:bg-black p-4'>{user? "Log out":"Sign up"}</li></NavLink>
